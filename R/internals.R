# Internal functions for twostageSL package
#
#
...
# .createLibrary()
# takes the input from library.2stage, library.1stage and sets up the library for twostageSL()
# library.2stage is a list with 2 parts, each part may be a character vector or a list, library.1stage may be a character vector or a list
...
# Scans over library.2stage, library.1stage and loads required packages.  This step is not necessary since most of the wrapper functions also include require() statements, but this helps detect missing packages early.
