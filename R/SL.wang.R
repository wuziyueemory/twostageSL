...
#'
#' This function implements the estimator developed by Wang and Zhou.
...
#' @references Wang HJ and Zhou XH. Estimation of the retransformed conditional mean in health care cost studies. Biometrika 2010; 97(1): 147–158.
#'
#' @export
#' @return
#' \describe{
